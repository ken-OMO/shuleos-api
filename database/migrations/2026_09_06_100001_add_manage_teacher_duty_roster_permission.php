...
{
    private const PERMISSION = 'manage_teacher_duty_roster';
    ...
    public function up(): void
    {
        DB::table('permissions')->insertOrIgnore([
            ...
            'description' => 'Manage Teacher Duty Roster',
            'created_at' => now(),
        ]);
        ...
        if (! $permissionId) {
            throw new RuntimeException(
                'Teacher duty roster management permission could not be resolved.'
            );
        }
        ...
        if ($resolvedRoleNames !== $requiredRoleNames) {
            throw new RuntimeException(
                'Required Teacher duty roster management system roles could not be resolved.'
            );
        }
    ...
    public function down(): void
    {
         ...
         * alter the Teacher-on-Duty authorization boundary.
         */
    }
};
