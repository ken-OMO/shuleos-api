...
class UpdateTeacherDutyWeeklyReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'highlights' => ['present', 'nullable', 'string'],
            'challenges' => ['present', 'nullable', 'string'],
            'recommendations' => ['present', 'nullable', 'string'],
            'school_id' => [
                'required',
                'uuid',
                function (
